...
<body>
 ...
 <div class="panel panel-default">
  <div class="panel-heading" align="center"><span class="t1">Worker</span></div>
			...
			<div class="col-lg-4">
			 ...
			 <?php
				...
				<div class="alert alert-success">
				  <strong>Register Success!</strong> <a href="login4.php">Login</a>
				</div>
				<?php
				}
                ...
                <div class="card-block">
                  ...
                  <form name="name" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <input type="text" name="dob" placeholder="D.O.B: dd-mm-yyyy" class="form-control">
                    </div>
					<div class="form-group">
                      <label>Address</label>
					...
					<div class="form-group">
                      <label>Working Home Address</label>
                      <input type="text" name="home" placeholder="Working HomeAddress" class="form-control">
                    </div>
                   <div class="form-group">
                      <label>Shift Time</label>
                      <input type="text" name="shift" placeholder="Shift Time" class="form-control">
                    </div>
					<!--<div class="form-group">
...
<div class="row">
	...
	<div class="col-lg-4">
			<div class="card">
					...
					Have an account? <a href="login4.php">Login</a>
					</div>
			</div>
	</div>
</div>			
 ...
 $msg="";
	 ...
	 $mq=mysql_query("select max(id) from reg_worker");
	 ...
	 $ins=mysql_query("insert into reg_worker(id,name,dob,address,mobile,email,home,shift,uname,pass) values($id,'$name','$dob','$address','$mobile','$email','$home','$shift','$uname','$pass')");
	 ...
	 window.location.href="register4.php?act=success";
	 </script>
	 <?php
	 	}
		else
		{
		 ?>
	 <script language="javascript">
	 window.location.href="register4.php?act=wrong";
	 </script>
	 <?php
		}
	 }
