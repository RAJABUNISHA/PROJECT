...
extract($_REQUEST);
	if(isset($btn))
	{
		$q1=mysql_query("select * from reg_security where uname='$uname' && pass='$pass' ");
			$n1=mysql_num_rows($q1);
				...
				{
				header("location:login3.php?act=wrong");
...
<div class="col-lg-4">
				...
				Don't have an account? <a href="register3.php">Sign Up</a>
				</div>
			</div>
			</div>
