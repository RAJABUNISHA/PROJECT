...
<div class="row">
	...
	<div class="col-lg-8">
	<h2 align="center">Needs</h2>
			  	<div  align="center">
				<?php
				
				$qry=mysql_query("select * from needs where status=1");
				...
				<thead>
				  <tr>
					...
					<th width="5%" class="bg-info">Address</th>
				...
				{
				$i++;
				$q1=mysql_query("select * from register where uname='".$row['uname']."'");
				$r1=mysql_fetch_array($q1);
				?>
				  <tr>
					<td class="bg-info2"><?php echo $i; ?></td>
					<td class="bg-info2"><?php echo $row['uname']; ?></td>
					<td class="bg-info2"><?php echo $r1['address']; ?></td>
					<th width="13%" class="bg-info2"><?php echo $row['details']; ?></th>
...
if($act=="ok")
{
mysql_query("update needs set status=1 where id=$did");
?>
<script language="javascript">
alert("Forward to Superident");
window.location.href="need2.php";
</script>
<?php
}
