...
<body>
 ...
 <div class="panel panel-default">
  <div class="panel-heading" align="center"><span class="t1">Security</span></div>
			...
			<div class="col-lg-4">
			 ...
			 <?php
				...
				<div class="alert alert-success">
				  <strong>Register Success!</strong> <a href="login3.php">Login</a>
				</div>
				<?php
				}
...
<div class="row">
	...
	<div class="col-lg-4">
			<div class="card">
					...
					Have an account? <a href="login3.php">Login</a>
					</div>
			</div>
	</div>
</div>			
 ...
 $msg="";
	 ...
	 $mq=mysql_query("select max(id) from reg_security");
	 ...
	 $ins=mysql_query("insert into reg_security(id,name,dob,address,mobile,email,uname,pass) values($id,'$name','$dob','$address','$mobile','$email','$uname','$pass')");
	 ...
	 window.location.href="register3.php?act=success";
	 </script>
	 <?php
	 	}
		else
		{
		 ?>
	 <script language="javascript">
	 window.location.href="register3.php?act=wrong";
	 </script>
	 <?php
		}
	 }
