...
<div class="row">
	...
	<div class="col-lg-8">
					...
					<div align="center">
					<table width="45%" border="0" cellpadding="5" cellspacing="5" bordercolor="#003399" class="table table-bordered">
				<thead>
				  <tr>
					<th width="3%" align="left" class="bg-info">Sno</th>
					<th width="5%" align="left" class="bg-info">Category</th>
				  </tr>
				</thead>
				<tbody>
				<?php
				...
				?>
				  <tr>
					<td align="left" class="bg-info2"><?php echo $i; ?></td>
					<td align="left" class="bg-info2"><?php echo $row['category']; ?></td>
				  </tr>
				  <?php
				  }
				  ?>
 ...
 $msg="";
	 ...
	 if(isset($btn))
	 {
	 		 ...
	 		 if(trim($category)=="") { $msg="Enter the Category"; }
			else
			{
			
	 $mq=mysql_query("select max(id) from category");
	 ...
	 $ins=mysql_query("insert into category(id,category) values($id,'$category')");
	 ...
	 <?php
		...
		else
		{
		 ?>
	 <script language="javascript">
	 window.location.href="add_cat.php?act=wrong";
	 </script>
	 <?php
		}
	 }
