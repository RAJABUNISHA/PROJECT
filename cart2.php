...
<div class="row">
	...
	<h2 align="center">Cart</h2>
				...
				$qry=mysql_query("select * from addcart where status=0");
				...
				?>
				  <tr>
					...
					echo '<a href="cart2.php?act=ok&did='.$row['id'].'">Deliver</a>';
					?></th>
				  </tr>
				  <?php
				  }
...
if($act=="ok")
{
mysql_query("update addcart set status=1 where id=$did");
?>
