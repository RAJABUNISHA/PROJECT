...
<body>
 ...
 <div class="panel panel-default">
  <div class="panel-heading" align="center">Security Allotment </div>
                ...
                <div class="card-block">
                  ...
                  <form name="name" method="post">
				   ...
				   <div class="form-group">
					  ...
					  {
					  ?>
					  <option value="<?php echo $r1['uname']; ?>"><?php echo $r1['apartment']."-".$r1['uname']; ?></option>
					  <?php
					  }
					  ?>
					  </select>
...
if(isset($btn))
	...
	mysql_query("update reg_security set owner='$owner' where id=$sid");
	 ?>
