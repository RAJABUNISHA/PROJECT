...
if(isset($btn))
{
$mq2=mysql_query("select max(id) from needs");
$mr2=mysql_fetch_array($mq2);
$id=$mr2['max(id)']+1;

mysql_query("insert into needs(id,uname,details,rdate,status) values($id,'$uname','$details','$rdate','0')");
?>
<script language="javascript">
window.location.href="need.php?act=success";
</script>
<?php
}
?>
