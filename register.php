...
<body>
 ...
 <div class="panel panel-default">
  <div class="panel-heading" align="center"><span class="t1">Apartment Owner </span></div>
                ...
                <div class="card-block">
                  ...
                  <form name="name" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <input type="text" name="aname" placeholder="Apartment Name" class="form-control">
                    </div>
					<div class="form-group">
                      <label>Address</label>
...
<div class="row">
 ...
 $msg="";
	 ...
	 $ins=mysql_query("insert into register(id,name,apartment,address,mobile,email,uname,pass) values($id,'$name','$aname','$address','$mobile','$email','$uname','$pass')");
